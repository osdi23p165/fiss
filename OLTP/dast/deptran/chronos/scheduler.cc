...
//Notification
//AVG notification txn_ids before relevance 2.1, after relevance 0.74
//If performance is issue, we may change the metadata to store pointers instead of txn_id.
