...
#define TPCC_COL_ORDER_O_ID                    (0)
#define TPCC_COL_ORDER_O_D_ID                  (1)
#define TPCC_COL_ORDER_O_W_ID                  (2)
#define TPCC_COL_ORDER_O_C_ID                  (3)
#define TPCC_COL_ORDER_O_ENTRY_D               (4)
#define TPCC_COL_ORDER_O_CARRIER_ID            (5)
#define TPCC_COL_ORDER_O_OL_CNT                (6)
#define TPCC_COL_ORDER_O_ALL_LOCAL             (7)

#define TPCC_COL_ORDER_LINE_OL_O_ID            (0)
#define TPCC_COL_ORDER_LINE_OL_D_ID            (1)
#define TPCC_COL_ORDER_LINE_OL_W_ID            (2)
#define TPCC_COL_ORDER_LINE_OL_NUMBER          (3)
...
#define TPCC_COL_ORDER_LINE_OL_DIST_INFO       (9)
