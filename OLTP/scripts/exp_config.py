...
DEPLOYMENT_FILE = '/htap/OLTP/dast/config/out.yml'
IMAGE_NAME = "10.22.1.9:5000/htap:latest"
NETWORK_BASE = "10.58"
NETWORK_NAME = "fiss_network"
CONTAINER_NAME_PREFIX = "fiss_"


N_SHARD_PER_REGION = 1
